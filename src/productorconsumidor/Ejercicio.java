...
public class Ejercicio implements Runnable{
    ...
    public Ejercicio(Tipo tipo,int id){
        this.tipo=tipo;
        this.id=id;
    }
    ...
    public static void main(String[] args) {
	    new Thread(new Ejercicio(Tipo.CONSUMIDOR,1)).start();
        new Thread(new Ejercicio(Tipo.PRODUCTR,1)).start();
        new Thread(new Ejercicio(Tipo.PRODUCTR,2)).start();
    }
